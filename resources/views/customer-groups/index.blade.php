<x-app-layout>
    <x-slot name="header">{{ __('Customer Groups') }}</x-slot>
    <x-slot name="headerDescription">Manage customer segments with default credit limits and payment terms.</x-slot>
    ...
    <div class="max-w-7xl mx-auto">
        <x-table-card :empty="count($customerGroups) === 0" emptyMessage="No customer groups found. Create one to get started." colspan="5">
            <thead>
                <tr>
                    ...
                    <th class="px-6 py-3 text-left text-xs font-medium text-slate-500 uppercase tracking-wider">Payment Terms</th>
            ...
            <tbody class="divide-y divide-slate-50">
                @forelse ($customerGroups as $group)
                    <tr class="hover:bg-slate-50/50 transition">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <x-action-links
                                :edit="route('customer-groups.edit', $group)"
