<x-app-layout>
    <x-slot name="header">Cash Transfers</x-slot>

    <div class="mb-4 flex justify-between items-center">
        <div></div>
        <a href="{{ route('cash-transfers.create') }}" class="erp-btn-primary">New Cash Transfer</a>
    </div>
            ...
            <table class="erp-table w-full">
                ...
                <tbody>
                    @forelse($transfers as $t)
                        <tr class="cursor-pointer" onclick="location.href='{{ route('cash-transfers.show', $t) }}'">
                            ...
                            <td class="text-sm text-right font-mono">{{ $t->exchange_rate ?? '-' }}</td>
                    ...
                    @empty
                        <tr><td colspan="7" class="text-center text-slate-400 py-8">No cash transfers.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
