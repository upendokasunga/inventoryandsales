<x-app-layout>
    <x-slot name="header">{{ __('Add Customer') }}</x-slot>

    <x-breadcrumbs :items="[['label' => 'Customers', 'url' => route('customers.index')], ['label' => 'Add Customer']]" />
    ...
    <div class="max-w-4xl mx-auto">
        <form action="{{ route('customers.store') }}" method="POST">
                ...
                <div class="p-6 space-y-4">
                    ...
                    <div>
                        <label class="inline-flex items-center">
                            <input type="checkbox" name="is_active" value="1" checked class="erp-input">
            ...
            <div class="flex justify-end gap-3">
                <a href="{{ route('customers.index') }}" class="erp-btn-secondary">Cancel</a>
                <button type="submit" class="erp-btn-primary">Create Customer</button>
            </div>
        </form>
    </div>
</x-app-layout>
