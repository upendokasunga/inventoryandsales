<x-app-layout>
    <x-slot name="header">{{ __('Create Stock Transfer') }}</x-slot>
    <div class="max-w-7xl mx-auto">
        <form action="{{ route('stock-transfers.store') }}" method="POST">
            ...
            <div class="flex justify-end mb-8">
                ...
                <button type="submit" class="inline-flex items-center px-4 py-2 erp-btn-primary">Create Stock Transfer</button>
            </div>
        </form>
    </div>
    @push('scripts')
