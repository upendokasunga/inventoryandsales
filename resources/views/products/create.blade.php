                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select name="product_type" id="product_type" class="mt-1 block w-full erp-input">
                            ...
                            <option value="goods" {{ old('product_type') == 'goods' ? 'selected' : '' }}>Goods</option>
                            <option value="service" {{ old('product_type') == 'service' ? 'selected' : '' }}>Service</option>
                            <option value="fixed_asset" {{ old('product_type') == 'fixed_asset' ? 'selected' : '' }}>Fixed Asset</option>
                        </select>
                    ...
                    <div>
                        ...
                        <input type="text" name="category" id="category" value="{{ old('category') }}" placeholder="Additional category info" class="mt-1 block w-full erp-input">
                    ...
                    <div id="units-container">
                        <div class="unit-row grid grid-cols-12 gap-3 mb-4 p-4 bg-slate-50 rounded-lg border border-slate-200">
                            <div class="col-span-5">
                                ...
                                <select name="units[0][unit_id]" required class="block w-full erp-input text-sm">
                            ...
                            <div class="col-span-5">
                                ...
                                <input type="number" step="0.001" min="0.001" name="units[0][conversion_factor]" value="1" required class="block w-full erp-input text-sm">
                            </div>
                ...
                <div class="p-6 grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div class="space-y-3 pt-6">
                        <label class="inline-flex items-center">
                            <input type="checkbox" name="tax_inclusive" value="1" {{ old('tax_inclusive', true) ? 'checked' : '' }} class="rounded border-slate-300 text-primary focus:ring-primary">
                            <span class="ml-2 text-sm text-slate-700">Tax Inclusive</span>
                        </label>
                        <label class="inline-flex items-center">
                            <input type="checkbox" name="track_stock" value="1" {{ old('track_stock', true) ? 'checked' : '' }} class="rounded border-slate-300 text-primary focus:ring-primary">
