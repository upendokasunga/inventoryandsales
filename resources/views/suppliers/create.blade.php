    ...
    <div class="max-w-7xl mx-auto">
        <form action="{{ route('suppliers.store') }}" method="POST">
                ...
                <div class="p-6">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="address" id="address" rows="2"
                            class="mt-1 block w-full rounded-lg border-blue-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">{{ old('address') }}</textarea>
                    </div>
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        <div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="notes" id="notes" rows="3"
                            class="mt-1 block w-full rounded-lg border-blue-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">{{ old('notes') }}</textarea>
                    </div>
                    <div class="mb-4">
            ...
            <div class="flex justify-end">
                ...
                <button type="submit" class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-blue-600 to-sky-500 hover:from-blue-500 hover:to-sky-400 border border-transparent rounded-lg font-semibold text-xs text-white shadow-lg shadow-blue-500/20 transition">Create Supplier</button>
            </div>
        </form>
    </div>
</x-app-layout>
