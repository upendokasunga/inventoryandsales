    ...
    <div class="max-w-7xl mx-auto">
        <form action="{{ route('suppliers.update', $supplier) }}" method="POST">
                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="phone1" id="phone1" value="{{ old('phone1', $supplier->phone1) }}"
                                class="mt-1 block w-full erp-input">
                            @error('phone1') <p class="mt-1 text-sm text-red-600">{{ $message }}</p> @enderror
                        </div>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                        <div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="address" id="address" rows="2"
                            class="mt-1 block w-full erp-input">{{ old('address', $supplier->address) }}</textarea>
            ...
            <div class="flex justify-end">
                ...
                <button type="submit" class="erp-btn-primary">Update Supplier</button>
            </div>
        </form>
    </div>
</x-app-layout>
