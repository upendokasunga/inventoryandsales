    ...
    <div class="max-w-7xl mx-auto">
        <form action="{{ route('suppliers.update', $supplier) }}" method="POST">
                ...
                <div class="p-6">
                    ...
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="phone1" id="phone1" value="{{ old('phone1', $supplier->phone1) }}"
                                class="mt-1 block w-full rounded-lg border-blue-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        </div>
                    </div>
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        <div>
                            ...
                            <input type="text" name="phone2" id="phone2" value="{{ old('phone2', $supplier->phone2) }}"
                                class="mt-1 block w-full rounded-lg border-blue-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                        </div>
                        <div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="address" id="address" rows="2"
                            class="mt-1 block w-full rounded-lg border-blue-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">{{ old('address', $supplier->address) }}</textarea>
                    </div>
                    <div class="grid grid-cols-2 gap-4 mb-4">
                        <div>
                    ...
                    <div class="mb-4">
                        ...
                        <textarea name="notes" id="notes" rows="3"
                            class="mt-1 block w-full rounded-lg border-blue-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">{{ old('notes', $supplier->notes) }}</textarea>
                    </div>
                    <div class="mb-4">
            ...
            <div class="flex justify-end">
                <a href="{{ route('suppliers.index') }}" class="mr-4 inline-flex items-center px-4 py-2 bg-white border border-blue-200 rounded-lg font-semibold text-xs text-slate-700 hover:bg-blue-50 transition">Cancel</a>
                <button type="submit" class="inline-flex items-center px-4 py-2 bg-gradient-to-r from-blue-600 to-sky-500 hover:from-blue-500 hover:to-sky-400 border border-transparent rounded-lg font-semibold text-xs text-white shadow-lg shadow-blue-500/20 transition">Update Supplier</button>
            </div>
        </form>
    </div>
</x-app-layout>
